...
<form action="/admin/libros/crear" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
	...
	Autor/es: <select name="autor[]" multiple >				
			...
			<input name="autor-checkbox" type="checkbox" defaultValue="off" value="{{Input::old('autor-checkbox')}}" title="Habilitar la creación de un nuevo autor" onchange="habilitarOtro(this,'autor-otro')" />Otro: 
	...
	Editorial: <select name="editorial[]">				
				...
				@endforeach			</select> 
			<input name="editorial-checkbox"  defaultValue="off" value="{{Input::old('editorial-checkbox')}}" type="checkbox" title="Habilitar la creación de una nueva editorial" onchange="habilitarOtro(this,'editorial-otro')"/>Otra: 
	...
	Idioma: <select name="idioma">				
			...
			<input name="idioma-checkbox" defaultValue="off" value="{{Input::old('idioma-checkbox')}}" type="checkbox" title="Habilitar la creación de un nuevo idioma" onchange="habilitarOtro(this,'idioma-otro')"/>Otro: 
    ...
    Etiqueta/as: <select name="etiqueta[]" multiple >
			...
			<input name="etiqueta-checkbox" type="checkbox" defaultValue="off" value="{{Input::old('etiqueta-checkbox')}}" title="Habilitar la creación de una nueva etiqueta" onchange="habilitarOtro(this,'etiqueta-otro')" />Otro: 
