...
@if (count($usuarios) == 0)
	<div class="mensaje mensaje-notificacion">No se encontró ningún usuario con ese dato. <a href="/admin/usuarios/vigentes" title="Regresar a la lista de usuarios">Haga click aquí para regresar a la lista.</a></div>
@endif
