...
@if (count($usuarios) == 0)
	<div class="mensaje mensaje-error">No se encontró ningún usuario con ese dato. <a href="/admin/usuarios/vigentes" title="Regresar a la lista de usuarios">Haga click para volver atrás.</a></div>
@endif
