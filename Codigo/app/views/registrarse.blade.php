...
<form method="post" action="/registrarse">
    ...
    Teléfono: <input name="teléfono" value="{{Input::old('teléfono')}}" placeholder="(0221) 450-8998"/> <span class="tooltip" title="El teléfono tener un mínimo de 7 caracteres. Se admiten caracteres especiales (paréntesis, -, #, +, etc).">[?]</span> <br/>
